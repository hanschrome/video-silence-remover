...
def remove_silence(input_file, output_file, threshold=-50, min_silence_length=1000, left_padding=0.1, right_padding=0.5):
    ...
    for start, end in nonsilent_slices:
        ...
        start = max(0, start - left_padding)  # Add left padding
        end += right_padding  # Add right padding
